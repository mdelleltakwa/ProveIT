...
<div class="pi-container pi-container-sm">
    ...
    <div class="pi-card animate-in">
        ...
        <form method="POST">
            ...
            <div class="pi-form-group">
                ...
                <textarea id="bio" name="bio" class="pi-textarea" placeholder="Tell us about yourself..."><?= htmlspecialchars($user['bio'] ?? '') ?></textarea>
            </div>
            <div class="pi-form-group">
                <form method="POST" enctype="multipart/form-data" action="index.php?controller=User&action=editProfile">
  <?= csrf_field() ?>

  <!-- ... tes champs name / email / bio ... -->
  ...
  <button type="submit">Save</button>
            ...
            <div class="pi-form-group">
                ...
                <input type="password" id="new_password" name="new_password" class="pi-input" placeholder="Min 6 characters">
            </div>
